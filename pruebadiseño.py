...
try:
    ...
    pil_image=Image.open("C:/Users/Public/proyecto_vuelos/UR.jpeg")
    app= Dash(__name__)
    ...
    app.layout = dbc.Container(fluid=True, children=[
            ...
            dbc.Container(
                [
                    html.A(
                        dbc.Row(
                            [
                                dbc.Col(html.Img(src=pil_image, height="80px"),align="center"),
                    ...
                    html.H2('Proyecto Vuelos', style={'textAlign': 'center','color': 'white' }),
                    dbc.Nav(   
                        [
        ...
        html.Div(id='page-content', style={'padding': '45px'})
    ])
